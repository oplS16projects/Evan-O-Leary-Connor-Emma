...
(define (run)
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (make-white (vl-append (item #:bullet (bitmap (arrowhead 20 0)) "Astronomers with telescopes")
               (vl-append
  ...
  (slide
   ...
   (t " ")
    ...
    (hc-append (bitmap "Sputnik_I.png")
               (make-white(vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:align 'left #:fill? #t #:width 480 "Analysis of the radio signals provided information about the ionosphere")
  ...
  (slide
   ...
   (t " ")
    ...
    (hc-append (bitmap "earthrise.png")
               (make-white (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:align 'left #:fill? #t #:width 480 "See the far side of the moon not visible from Earth's surface")
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (make-white (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:width 480 (bt "July 21, 1969: ") "Neil Armstrong and Buzz Aldrin became the first humans to step foot on another celestial body, the moon")
               (vl-append
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (make-white (vl-append (item #:bullet (bitmap (arrowhead 20 0)) "Loss of power")
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (make-white (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:width 480 (bt "1998: ") "The first pieces of the International Space Station (ISS) were launched")
               (vl-append
                (make-white (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:width 480 (bt "Since 2001: ") "A crew of either 2 or 6 have been aboard the ISS at all times")
  ...
  (slide
   ...
   (t " ")
    ...
    (hc-append (bitmap "eros.png")
               (make-white (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:align 'left #:fill? #t #:width 500 (bt "February 4,1996: ") "Launched")
                          (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:align 'left #:fill? #t #:width 500 (bt "February 16, 2000: ") "Orbit around Eros")
                                     (item #:bullet (bitmap (arrowhead 20 0)) #:align 'left #:fill? #t #:width 500 (bt "February 28, 2001: ") "Landed on Eros and sent last signal"))))))
  ...
  (slide
   ...
   (t " ")
    ...
    (hc-append (bitmap "space_launch_system.png")
               (make-white (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:align 'left #:fill? #t #:width 500 (bt "China: ") "Launch a 60 ton multi-module space station into orbit by 2020")
