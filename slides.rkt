...
(define (run)
 (slide-number 1)
  ...
  (slide
   ...
   (para #:width 900 #:fill? #t (bt "Space Exploration") "is the ongoing discovery and exploration of celestial structures in outer space by means of continuously evolving and growing space technology. The study of space is carried out by the following means:")
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:width 480 (bt "July 21, 1969: ") "Neil Armstrong and Buzz Aldrin became the first humans to step foot on another celestial body, the moon")
               (vl-append
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:width 480 (bt "1998: ") "The first pieces of the International Space Station (ISS) were launched")
               (vl-append
                (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:width 480 (bt "Since 2001: ") "A crew of either 2 or 6 have been aboard the ISS at all times")
  ...
  (slide
   ...
   (t " ")
    ...
    (hc-append (bitmap "eros.png")
               (vl-append (item #:bullet (bitmap (arrowhead 20 0)) #:align 'left #:fill? #t #:width 500 (bt "February 4,1996: ") "Launched")
