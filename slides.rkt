...
;; Sets color on text or bullets 
(define (make-color slide)
  (colorize slide "White"))
...
;; Make slide numbers more visible
...
(define (run)
  ...
  (slide
   ...
   (make-color (para #:width 900 #:fill? #t (bt "Space Exploration") "is the ongoing discovery and exploration of celestial structures in outer space by means of continuously evolving and growing space technology. The study of space is carried out by the following means:"))
   ...
   (lt-superimpose
    ...
    (make-color (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) "Astronomers with telescopes")
               (vl-append
                (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) "Human space flight")
  ...
  (slide
   ...
   (make-color (para #:width 900 #:fill? #t "The Soviet Union launched Sputnik I (\"Satellite 1\") on October 4, 1957. Sputnik I orbited Earth at a height of around 160 miles. Two radio transmitters sent beeps at 20 and 40 MHz."))
  ...
  (slide
   ...
   #:timeout 15 #:gap-size 12
   (make-color (para #:width 900 "On April 12, 1961 the first successful human spaceflight was Vostok I (\"East 1\"), carrying 27 year old cosmonaut Yuri Gagarin. The flight made one orbit around Earth lasting about 1 hour and 48 minutes."))
   (t " ")
  ...
  (slide
   ...
   (make-color (para #:width 900 #:fill? #t "On December 21, 1968 Apollo 8, NASA's second manned space mission launched. It orbited the moon 10 times in 20 hours and was the first spacecraft to leave Earth's orbit, orbit the moon, and return safely home. The three astronauts Frank Bowman, James Lovell, and William Anders were the first to:"))

   (t " ")

    (hc-append (bitmap "earthrise.png")
               (make-color (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) #:align 'left #:fill? #t #:width 480 "See the far side of the moon not visible from Earth's surface")
                          (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) #:align 'left #:fill? #t #:width 480 "See Earth as a whole planet"))))))
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (make-color (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) #:width 480 (bt "July 21, 1969: ") "Neil Armstrong and Buzz Aldrin became the first humans to step foot on another celestial body, the moon")
               (vl-append
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (make-color (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) "Loss of power")
               (make-color (vl-append
                (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) "Loss of cabin heat")
  ...
  (slide
   ...
   (make-color (para #:width 900 "The Hubble Space Telescope became the first observatory placed in space in 1990. The advantages of a telescope in space are a lack of dust and clouds, therefore many powerful images have been produced by the Hubble."))
   (t " ")
  ...
  (slide
   ...
   (lt-superimpose
    ...
    (make-color (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) #:width 480 (bt "1998: ") "The first pieces of the International Space Station (ISS) were launched")
               (vl-append
                (make-color (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) #:width 480 (bt "Since 2001: ") "A crew of either 2 or 6 have been aboard the ISS at all times")
  ...
  (slide
   ...
   #:timeout 25 #:gap-size 12
    (make-color (para #:width 900 #:fill? #t "NEAR-Shoemaker was a NASA mission designed to orbit an asteroid. The asteroid NEAR was to orbit was Eros, a large near Earth asteroid, and return data on composition, mineralogy, morphology, and magnetic field to answer questions about these asteroids. Important dates of the mission are:"))

   (t " ")

    (hc-append (bitmap "eros.png")
               (make-color (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) #:align 'left #:fill? #t #:width 500 (bt "February 4,1996: ") "Launched")
                          (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) #:align 'left #:fill? #t #:width 500 (bt "February 16, 2000: ") "Orbit around Eros")
  ...
  (slide
   ...
   (make-color (para #:width 900 "The image, dubbed eXtreme Deep Field, is comprised of 10 years worth of photos taken by the Hubble space telescope. The photo depicts thousands of galaxies that are light years away."))
   (t " ")
  ...
  (slide
   ...
   #:timeout 12 #:gap-size 12
   (make-color (para #:width 900 #:fill? #t "The future of space exploration will be funded by both private investors and traditional governments. Some of the goals stated are:"))

   (t " ")

    (hc-append (bitmap "space_launch_system.png")
               (make-color (vl-append (item #:bullet (bitmap (make-color (arrowhead 20 0))) #:align 'left #:fill? #t #:width 500 (bt "China: ") "Launch a 60 ton multi-module space station into orbit by 2020")
